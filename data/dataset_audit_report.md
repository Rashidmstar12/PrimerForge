...
| :--- | :--- | :---: | :---: |
| **Total Primer Pairs** | All | 3,278 | 100.00% |
| **Source DB** | primerbank | 2720 | 82.98% |
|  | synthetic | 450 | 13.73% |
|  | artic | 95 | 2.90% |
|  | origene | 10 | 0.31% |
|  | rtprimerdb | 3 | 0.09% |
| **Label** | label=1 (Functional) | 2827 | 86.24% |
| | label=0 (Non-Functional) | 451 | 13.76% |
| **Confidence** | High | 107 | 3.26% |
| | Medium | 3171 | 96.74% |
| | Low | 0 | 0.00% |
| **Negative Type** | Synthetic Negatives | 450 | 13.73% |

## Section 2 — Sequence Statistics

| Metric | Mean ± Std | Min | Max |
| :--- | :---: | :---: | :---: |
| **Forward Length (nt)** | 21.18 ± 1.84 | 19.0 | 34.0 |
| **Reverse Length (nt)** | 21.35 ± 1.90 | 19.0 | 33.0 |
| **GC Content (%)** | 50.34% ± 7.77% | 10.0% | 73.7% |
| **Melting Temperature (°C)** | 57.21°C ± 2.42°C | 40.9°C | 69.2°C |
...
- **Unique Genes Represented**: 1125
- **Organism Breakdown**:
  - *human*: 3180 pairs (97.01%)
  - *sars-cov-2*: 95 pairs (2.90%)
...
- **Singletons Count**: 2613 clusters
